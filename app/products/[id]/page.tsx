...
const products: Record<string, Product> = {
  "1": {
    ...
    price: 1299,
    images: [
      "/assets/images/kandura-1.avif?height=300&width=300",
      "/assets/images/kandura-1.avif?height=300&width=300",
      "/assets/images/kandura-1.avif?height=300&width=300",
      "/assets/images/kandura-1.avif?height=300&width=300",
    ],
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="space-y-4">
          <div className="relative aspect-square overflow-hidden rounded-lg">
            <Image
              src={product.images[selectedImage] || "/assets/images/kandura-1.avif"}
              alt={product.name}
              fill
          ...
          <div className="grid grid-cols-4 gap-2">
            {product.images.map((image, index) => (
              ...
              >
                <Image
                  src={image || "/assets/images/kandura-1.avif?height=300&width=300"}
              ...
              <Link href={`/products/${productId}`} key={productId}>
                <Card className="product-card overflow-hidden h-full">
                  <div className="relative aspect-square">
                    <Image
                      src={relatedProduct.image || "/assets/images/kandura-1.avif?height=300&width=300"}
